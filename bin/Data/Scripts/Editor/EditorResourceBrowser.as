...
const int RESOURCE_TYPE_NAVFILE = 25;

// any resource type > 0 is valid
const int NUMBER_OF_VALID_RESOURCE_TYPES = 25;
...
int GetResourceType(StringHash fileType)
{
    ...
    //Lumak - navfile ext
    else if (fileType == EXTENSION_TYPE_NAVFILE)
        return RESOURCE_TYPE_NAVFILE;
...
bool GetExtensionType(String path, StringHash &out fileType)
{
    ...
    //Lumak - navfile ext
    else if(type == EXTENSION_TYPE_NAVFILE)
        fileType = EXTENSION_TYPE_NAVFILE;
    else
        return false;
